...
class SegmentationNeuroblastoma(TaskConfig):
    ...
    def infer(self) -> Union[InferTask, Dict[str, InferTask]]:
        task: InferTask = lib.infers.SegmentationNeuroblastoma(
        path=self.path,
    ...
    def trainer(self) -> Optional[TrainTask]:
        ...
        task: TrainTask = lib.trainers.SegmentationNeuroblastoma(
        ...
        if self.epistemic_enabled:
            methods[f"{self.name}_epistemic"] = EpistemicScoring(
                ...
                network=UNet(
                    ...
                    transforms=lib.infers.SegmentationNeuroblastoma(None).pre_transforms(),
